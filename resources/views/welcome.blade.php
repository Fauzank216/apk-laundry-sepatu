    ...
    <main class="flex md:items-center justify-center h-screen">
        <div class="bg-white md:flex md:gap-3 md:justify-center md:w-7xl md:h-[550px]">
            ...
            <div class="p-3 md:p-8 flex justify-center items-center flex-col flex-1">
                <div class="py-4">
                    <p class="text-lg text-center md:mb-2">👟Laundry-Sepatu</p>
                    <p class="text-2lg md:text-3xl text-center font-semibold text-teal-900 font-sans">Hai, selamat
                        datang
                        kembali
                    </p>

                </div>
                <div class="text-xs md:text-base md:mt-3 w-full">
                    <div class="hidden">
                        <form action="#">
                            <div class="mb-3">
                    ...
                    <div>
                        ...
                        <p class="my-2 text-center text-teal-500">Sudah punya akun? <span
                                class="underline font-semibold hover text-teal-600 cursor-pointer">Login</span></p>
                    </div>
                </div>
            </div>
        </div>
